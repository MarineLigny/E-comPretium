function Header() {
    return (
        ...
        <a href="menu.html" className="btn-icon" title="Ouvrir le menu" aria-label="Ouvrir le menu">
        ...
        <a href="search.html" className="btn-icon"  title="Rechercher" aria-label="Rechercher">
